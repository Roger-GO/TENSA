...
| --- | --- | --- | --- |
| websocket | `/api/ws/{session_id}/sweep/{sweep_id}` | `server/src/andes_app/api/routes/sweep.py` | yes |
| websocket | `/api/ws/{session_id}/jobs/events` | `server/src/andes_app/api/routes/jobs.py` | yes |
| websocket | `/api/ws/{session_id}` | `server/src/andes_app/api/routes/ws.py` | yes |
| mount | `spa (/)` | `server/src/andes_app/api/app.py` | yes |
