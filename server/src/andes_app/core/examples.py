...
When ``andes-app serve`` starts against a workspace that contains ZERO
...
from andes_app.security.paths import list_workspace_files

log = logging.getLogger("andes-app.examples")

# Mirrors the workspace lister's supported-extension set (see
# ``andes_app.api.routes.workspace._ALLOWED_EXTENSIONS``): the workspace
