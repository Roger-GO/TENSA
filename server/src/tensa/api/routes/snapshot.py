...
The bundle assembly orchestrator lives in ``tensa.core.bundle``; the
snapshot orchestrator lives in ``tensa.core.snapshot``. This module
...
@router.post(
    ...
    openapi_extra={"x-tensa-gui-location": "snapshot-dialog"},
