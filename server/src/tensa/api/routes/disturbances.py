...
@router.post(
    ...
    openapi_extra={"x-tensa-gui-location": "disturbance-panel"},
...
@router.get(
    ...
    openapi_extra={
        ...
        "x-tensa-parity-deferred": "Recorded disturbances are mirrored in the disturbance-panel Zustand store and rehydrated from snapshot restore; the web client never re-reads them via this GET (read-back endpoint kept for API/agent parity).",
    },
